...
for R1_FILE in "$RAW_DIR"/*_R1_001.fastq.gz; do
  ...
  echo "[1/8] Calculating initial stats..."
  ...
  echo "[4/8] Cleaning reads (polyA/T trimming, N removal, length filter)..."
  bbduk.sh \
